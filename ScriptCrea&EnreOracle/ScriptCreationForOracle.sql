...
-- SLOT_ARMURE
   ...
   CREATE OR REPLACE TRIGGER New_Slot_Armure_trigger
   BEFORE INSERT ON SLOT_ARMURE
   FOR EACH ROW
   BEGIN
     -- Utilisation de la séquence pour générer la valeur Id
     :NEW.Id := SLOT_ARMURE_seq.NEXTVAL;
   END;
   /
...
-- SLOT_ARME
   ...
   CREATE OR REPLACE TRIGGER New_Slot_Arme_trigger
   BEFORE INSERT ON SLOT_ARME
   FOR EACH ROW
   BEGIN
     -- Utilisation de la séquence pour générer la valeur Id
     :NEW.Id := SLOT_ARME_seq.NEXTVAL;
   END;
   /
...
-- CARACTERISTIQUE
   ...
   CREATE OR REPLACE TRIGGER New_Caracteristique_trigger
   BEFORE INSERT ON CARACTERISTIQUE
   FOR EACH ROW
   BEGIN
     -- Utilisation de la séquence pour générer la valeur Id
     :NEW.Id := CARACTERISTIQUE_seq.NEXTVAL;
   END;
   /
